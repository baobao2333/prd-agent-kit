...
- Change HTML review style: `skills/prd-html-review-artifact/SKILL.md`
...
The most important principle is: stage files should make uncertainty visible, not hide it inside polished prose.
